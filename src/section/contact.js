        ...
        <div className="container px-4 mx-auto">
          <div className="flex flex-wrap mb-24 lg:mb-18 justify-between items-center">
            <div className="w-full lg:w-1/2 mb-10 lg:mb-0">
              ...
              <p className="text-lg md:text-xl text-coolGray-400 font-medium">
                Para cotizar tu avalúo con nosotros, nuestro equipo de
                valuadores esta a su disposición para darle respuesta de forma
                inmediata.
              </p>
            </div>
          ...
          <div className="flex flex-wrap -mx-4">
              ...
              <div className="flex flex-wrap -mx-4">
                <div className="w-full md:w-1/2 px-4 mb-10">
                  <div className="max-w-xs mx-auto">
                    ...
                    <h3 className="mb-4 text-2xl md:text-3xl leading-9 text-white font-bold">
                      Email
                    </h3>
                    <a
                      className="text-lg md:text-xl text-coolGray-400 hover:text-coolGray-500 font-medium"
                      href="mailto:#"
                    >
                ...
                <div className="w-full md:w-1/2 px-4">
                  <div className="max-w-xs mx-auto">
                    ...
                    <h3 className="mb-9 text-2xl md:text-3xl leading-9 text-white font-bold">
                      Socials
                    </h3>
                    <a
            ...
            <div className="w-full lg:w-1/2 px-4">
              <div className="px-4 py-8 md:p-10 bg-white rounded-md">
                <form>
                  <div className="mb-6">
